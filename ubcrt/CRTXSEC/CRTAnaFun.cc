...
/*std::vector<crt::CRTHit> crtana::auxfunc::getCRTHitVector(art::Event const & evt, std::string data_label_hits_){
  ...
  void crtana::auxfunc::CollectTracksAndShowers(const PFParticleVector &particles, const PFParticleHandle &pfParticleHandle, const art::Event &evt, TrackVector &tracks, ShowerVector &showers, 
...
void crtana::auxfunc::CollectTracksAndShowersWpdgCode(const PFParticleVector &particles, const PFParticleHandle &pfParticleHandle, const art::Event &evt, TrackVector &tracks, ShowerVector &showers, 
                                                std::string m_trackLabel, std::string m_showerLabel, std::vector<int> &pdg_track, std::vector<int> &pdg_shower)
  {
      // Get the associations between PFParticles and tracks/showers from the event
      ...
      for (const art::Ptr<recob::PFParticle> &pParticle : particles)
      {
        ...
        //std::cout << "Momentum: " << momentumStart << std::endl;
          ...
          {
              showers.push_back(associatedShowers.front());
              pdg_shower.push_back(pParticle.get()->PdgCode() );
              continue;
          }
...
void crtana::auxfunc::CollectTracksAndShowersWpfparticleID(const PFParticleVector &particles, const PFParticleHandle &pfParticleHandle, const art::Event &evt, TrackVector &tracks, ShowerVector &showers, 
                                                std::string m_trackLabel, std::string m_showerLabel, std::vector<int> &track_id, std::vector<int> &shower_id)
  {
      // Get the associations between PFParticles and tracks/showers from the event
      ...
      for (const art::Ptr<recob::PFParticle> &pParticle : particles)
      {
        ...
        //std::cout << "Momentum: " << momentumStart << std::endl;
          ...
          {
              tracks.push_back(associatedTracks.front());
              track_id.push_back(pfParticle_nr );
              pfParticle_nr++;
              continue;
          }
          ...
          {
              showers.push_back(associatedShowers.front());
              shower_id.push_back(pfParticle_nr );
              pfParticle_nr++;
              continue;
          }
