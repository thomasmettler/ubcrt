...
void TPCTrackAnalyser::analyze(art::Event const & evt)
{
  ...
  std::vector<recob::Track> const& TPCTrackCollection2(*rawHandle_TPCtrack2);    
  /*
  ...
  */
  ...
  for(std::vector<int>::size_type i = 0; i != TPCTrackCollection.size(); i++) {    //start loop over tpc tracks
    ...
    recob::Track my_TPCTrack2 = TPCTrackCollection2[i]; 
    
    
    std::cout << "Track1: " << my_TPCTrack.Length() << " - " << my_TPCTrack.Start().X() << " - " << my_TPCTrack.End().X() << " - " << my_TPCTrack.Theta()  << " - " << my_TPCTrack.Phi() << std::endl;
    std::cout << "Track2: " << my_TPCTrack2.Length() << " - " << my_TPCTrack2.Start().X() << " - " << my_TPCTrack2.End().X() << " - " << my_TPCTrack2.Theta()  << " - " << my_TPCTrack2.Phi() << std::endl;
    std::cout << std::endl;
    std::cout << "Diff 1: " << my_TPCTrack.Length()-my_TPCTrack2.Length() << " - " << my_TPCTrack.Start().X()-my_TPCTrack2.Start().X() << " - " << my_TPCTrack.End().X()-my_TPCTrack2.End().X() << " - " << my_TPCTrack.Theta()-my_TPCTrack2.Theta()  << " - " << my_TPCTrack.Phi()-my_TPCTrack2.Phi() << std::endl;
    std::cout << std::endl;
