...
namespace crtana {
  ...
  namespace auxfunc {
    ...
    void CollectTracksAndShowersWpdgCode(const PFParticleVector &particles, const PFParticleHandle &pfParticleHandle, const art::Event &evt, TrackVector &tracks, ShowerVector &showers,std::string m_trackLabel, std::string m_showerLabel, std::vector<int> &pdg_track, std::vector<int> &pdg_shower);
    
    void CollectTracksAndShowersWpfparticleID(const PFParticleVector &particles, const PFParticleHandle &pfParticleHandle, const art::Event &evt, TrackVector &tracks, ShowerVector &showers, std::string m_trackLabel, std::string m_showerLabel, std::vector<int> &track_id, std::vector<int> &shower_id);
